...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.8\textwidth]{meter_eleph/error_plot_alpha_var}
...
\begin{figure} [H]
    \centering
    \begin{subfigure}
        \includegraphics[width=0.7\textwidth]{meter_eleph/error_plot_division}
    \end{subfigure}
    \begin{subfigure}
...
\section {Results} \label{sec:change_results}

% Window size graphs, comparaison to the real 
