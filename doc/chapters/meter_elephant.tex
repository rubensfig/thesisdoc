...
\par In spite of the expected result of quicker detection for smaller windows, figure \ref{fig:time_error} does not present much variation in the detection time
